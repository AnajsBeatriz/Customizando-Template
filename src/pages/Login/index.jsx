...
const Login = ({ onLogin }) => {
  ...
  return (
    ...
    <Box
      ...
      minHeight="100vh"
    >
      <h2 style={{ color: '#4a148c' }}>Bem vindo a Lista de Tarefas</h2>
      ...
      <FormControl sx={{ marginBottom: '16px' }}>
        ...
        <Input
          ...
          sx={{
            ...
            border: '1px solid #4a148c', // Cor azul
          }}
        />
      ...
      <h4 style={{ color: '#e0e0e0' }}>Dev Ana Js Beatriz</h4>
